...
class FB15K(BaseDataset):
    ...
    def __init__(self, args):
        ...
        self.data_root = os.path.join(args.dataset_root, 'fb15k')
        if not os.path.exists(self.data_root):
            os.makedirs(self.data_root, exist_ok=True)
            for url in [
                    "https://raw.githubusercontent.com/thunlp/OpenKE/OpenKE-PyTorch/benchmarks/FB15K/train2id.txt",
                    "https://raw.githubusercontent.com/thunlp/OpenKE/OpenKE-PyTorch/benchmarks/FB15K/test2id.txt",
                    "https://raw.githubusercontent.com/thunlp/OpenKE/OpenKE-PyTorch/benchmarks/FB15K/valid2id.txt",
                    "https://raw.githubusercontent.com/thunlp/OpenKE/OpenKE-PyTorch/benchmarks/FB15K/relation2id.txt",
                    "https://raw.githubusercontent.com/thunlp/OpenKE/OpenKE-PyTorch/benchmarks/FB15K/entity2id.txt",
                ]:
